class Operations::Products::Clinics::Dates::List
  include ActiveModel::Model

  attr_accessor :status, :type, :message

  def initialize(params)
    @date_params = params.require(:date).permit(:clinic_id)
  ...
  def dates
    @dates ||= ::Operations::Products::DateRepository.all_active_product(@date_params[:clinic_id])
  end
  ...
  def can_current_user_list_date?
    ::UserPolicies.new(@current_user_params[:current_user_id], "list", "medclinic_dates").can_current_user?
  end
