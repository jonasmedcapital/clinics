class Operations::Products::Clinics::MonthlyCalculations::List
  ...
  def calculations
    @calculations ||= ::Operations::Products::Clinics::MonthlyCalculationRepository.all_active_clinic(@calculation_params[:clinic_id])
  end
  ...
  def data
    ...
    cln = ::Operations::Products::Clinics::MonthlyCalculationRepository.list_all(@calculations)
