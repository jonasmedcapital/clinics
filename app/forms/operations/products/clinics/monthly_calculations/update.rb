class Operations::Products::Clinics::MonthlyCalculations::Update
  ...
  def calculation
    @calculation ||= ::Operations::Products::Clinics::MonthlyCalculationRepository.find_by_id(@calculation_params[:id])
  end
  ...
  def save
    ...
    ActiveRecord::Base.transaction do
      ...
      if @valid
        @calculation.save
        Operations::Products::Clinics::Calculations::UpdateYearlyCalculationService.new(@calculation)
        @data = true
        @status = true
        @process = true
        @type = true
