class Operations::Products::Clinics::Invoices::Entity::Delete
  ...
  def entity
    @entity ||= ::Operations::Products::EntityRepository.find_by_id(@entity_params[:id])
  end
  ...
  def data
    ...
    cln = ::Operations::Products::EntityRepository.read @entity
