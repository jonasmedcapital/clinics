class Users::Accounts::Entities::ReadProducts
  ...
  def data
    ...
    products = ::Users::Accounts::EntityRepository.read_products_with_permisssion @account, @current_user
    return {:cln => products}.as_json
  end
