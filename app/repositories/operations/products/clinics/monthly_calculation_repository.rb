class Operations::Products::Clinics::MonthlyCalculationRepository < Base
  ...
  def self.find_year_month(clinic_id, year, start_month, end_month)
    entity.where(clinic_id: clinic_id, year: year, month: start_month..end_month)
  end
  ...
  def self.entity
    "Operation::Product::Clinic::MonthlyCalculation".constantize
  end

  def self.mapper
    "Operations::Products::Clinics::MonthlyCalculationMapper".constantize
  end
